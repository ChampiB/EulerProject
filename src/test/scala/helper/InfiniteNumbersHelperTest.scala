...
class InfiniteNumbersHelperTest extends FunSuite {
  ...
  test("InfiniteNumbersHelper.among") {
    assert(InfiniteNumbersHelper.among("3", "5") == "10")
    assert(InfiniteNumbersHelper.among("2", "5") == "10")
    assert(InfiniteNumbersHelper.among("1", "5") == "5")
  }
}
